...
import GlowHeading from "../normalUI/GlowCard";
...
function HeroSection() {
    ...
    return (
        <div className="w-full">
            {/* Hero Section with Bulb Glow and Sparkles */}
                            ...
                            <NavigationMenuList className="flex gap-6 justify-center">
                                ...
                                <NavigationMenuItem>
                                    <NavigationMenuLink href="#"
                                        className="transition duration-300 font-semibold text-gray-300 hover:text-white hover:drop-shadow-[0_0_4px_rgba(34,211,238,0.7)]">About</NavigationMenuLink>
                                </NavigationMenuItem>
                                <NavigationMenuItem>
                                    <NavigationMenuLink href="#"
                                        className="transition duration-300 font-semibold text-gray-300 hover:text-white hover:drop-shadow-[0_0_4px_rgba(34,211,238,0.7)]">Contact</NavigationMenuLink>
                                </NavigationMenuItem>
                            </NavigationMenuList>
                        </div>
                        ...
                        {showSignIn && (
                            <div className="fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-20 px-4">
                                ...
                                <div className="relative w-full max-w-md my-10 z-10">
                                    ...
                                    {/* Scrollable Form Area inside Glow Card */}
                                    <BackgroundGradient className="rounded-2xl overflow-hidden">
                                        <div
                                            className="max-h-[80vh] overflow-y-auto scrollbar-none"
                                            style={{
                                                // Fallback for cross-browser scrollbar hiding
